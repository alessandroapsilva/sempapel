...
<!-- Link direto para a folha de estilo oficial para garantir o fundo e layout corretos -->
...
<siga:pagina titulo="Página de Login" desabilitarbusca="sim"
	...
	<!-- Configura as variáveis do modelo ENFAS Sem Papel -->
	...
	<c:if test="${!isSenhaUsuarioExpirada}">		
		<script>					
			$(function() {								
				...
				// Script para forçar a classe de fundo escuro no body da página
