...
<!-- Link direto para a folha de estilo oficial do SP Sem Papel para garantir o fundo e layout corretos -->
...
<siga:pagina titulo="Página de Login" desabilitarbusca="sim"
	...
	<!-- Configura as variáveis idênticas ao modelo do GOVSP -->
	<c:set var="login_box_class" value="box_login" />
	<c:set var="login_box_logo" value="/siga/imagens/logo-enfas-sem-papel-cor.png" />
	<c:set var="login_box_logo_size" value="132" />
	<c:set var="login_box_text" value="" />
	<c:set var="login_titulo_modal" value="ENFAS Sem Papel"/>
					...
					<form id="formLogin" role="form" method="post"
						...
						<div class="form-group">
						    ...
						    <div class="input-group">
						      ...
						      <input id="username" type="text" name="username" placeholder="Digite seu CPF ou matrícula" onblur="javascript:converteUsuario(this)" autocorrect="off"
						...
						<div class="form-group">
							...
							<div class="input-group">
						      ...
						      <input type="password" name="password" id="password" placeholder="Senha"
								class="form-control" aria-label="Senha" aria-describedby="icon-pass">
						    </div>						
						</div>						
	...
	<c:if test="${!isSenhaUsuarioExpirada}">		
		<script>					
			$(function() {								
				...
				// Script para forçar a classe de fundo escuro nativa do GOVSP no body da página
				$('body').addClass('login_body_color');
			});
		</script>
	</c:if>
...
</c:if>	<div class="container content pt-2">
		<div class="row justify-content-center">
			<div class="col col-sm-12 col-md-5">
				<div class="jumbotron d-block mx-auto ${login_box_class}">
