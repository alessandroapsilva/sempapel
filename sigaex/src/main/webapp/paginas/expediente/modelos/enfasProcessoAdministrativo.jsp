...
<mod:modelo>
  <mod:entrevista>
    <mod:grupo titulo="Termo de abertura do processo"><mod:grupo><mod:editor titulo="" var="termoAbertura" /></mod:grupo></mod:grupo>
  </mod:entrevista>
  <mod:documento>
    <html xmlns="http://www.w3.org/1999/xhtml"><head><style type="text/css">
      @page { margin: 2cm 2cm 2cm 3cm; }
      body { font-family: Arial; font-size: 11pt; line-height: 1.5; }
      .titulo { text-align:center; font-weight:bold; font-size:13pt; margin-bottom:1.5em; }
      .corpo { text-align:justify; }
    </style></head><body>
      <p class="titulo">PROCESSO ADMINISTRATIVO Nº ${doc.codigo}</p>
      ...
      <div class="corpo">${termoAbertura}</div>
