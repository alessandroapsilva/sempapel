...
<mod:modelo>
  <mod:entrevista>
    <mod:grupo titulo="Conteúdo do parecer"><mod:grupo><mod:editor titulo="" var="textoParecer" /></mod:grupo></mod:grupo>
  </mod:entrevista>
  <mod:documento>
