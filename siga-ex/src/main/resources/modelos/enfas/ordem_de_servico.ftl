...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="ORDEM DE SERVIÇO" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        <p><strong>Responsável:</strong> ${responsavel!}</p>[#if (prazo!"") != ""]<p><strong>Prazo:</strong> ${prazo!}</p>[/#if]
