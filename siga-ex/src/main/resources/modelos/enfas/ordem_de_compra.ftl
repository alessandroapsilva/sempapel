...
[@grupo titulo="Processo de compra"]
    ...
    [@grupo][@texto titulo="CNPJ do fornecedor" var="cnpjFornecedor" largura="24" maxcaracteres="24"/][@data titulo="Entrega prevista" var="entregaPrevista"/][/@grupo]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="ORDEM DE COMPRA" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>CNPJ:</strong> ${cnpjFornecedor!} &nbsp; <strong>Entrega prevista:</strong> ${entregaPrevista!}</p>
[#if qtdItens??]
