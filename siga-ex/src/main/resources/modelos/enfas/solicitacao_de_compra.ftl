...
[@grupo titulo="Processo de compra"]
    ...
    [@grupo][@texto titulo="Centro de custo" var="centroCusto" largura="35" maxcaracteres="80"/][@data titulo="Necessidade até" var="dataNecessidade"/][/@grupo][@memo titulo="Justificativa da compra" var="justificativaCompra" colunas="90" linhas="4" obrigatorio=true/]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="SOLICITAÇÃO DE COMPRA" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>Centro de custo:</strong> ${centroCusto!}</p><p><strong>Justificativa:</strong><br/>${justificativaCompra!}</p>
[#if qtdItens??]
