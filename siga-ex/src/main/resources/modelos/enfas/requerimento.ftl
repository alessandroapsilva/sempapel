...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="REQUERIMENTO" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        <p><strong>Requerente:</strong> ${requerente!} ${documentoRequerente!}</p><p><strong>Pedido:</strong> ${pedido!}</p>
