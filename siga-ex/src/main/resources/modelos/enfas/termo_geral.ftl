...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="TERMO" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        <p><strong>Primeira parte:</strong> ${parteUm!}</p>[#if (parteDois!"") != ""]<p><strong>Segunda parte:</strong> ${parteDois!}</p>[/#if]
