...
[@grupo titulo="Processo de compra"]
    ...
    [@grupo][@texto titulo="Condição de pagamento" var="condicaoPagamento" largura="45" maxcaracteres="100"/][@data titulo="Previsão de entrega" var="previsaoEntrega"/][/@grupo]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="PEDIDO DE COMPRA" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>Condição de pagamento:</strong> ${condicaoPagamento!}</p><p><strong>Previsão de entrega:</strong> ${previsaoEntrega!}</p>
[#if qtdItens??]
