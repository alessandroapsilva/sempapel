[#--
 Modelo: Atestado de Recebimento
...
[@grupo titulo="Processo de compra"]
    ...
    [@grupo][@data titulo="Data do recebimento" var="dataRecebimento" obrigatorio=true/][@selecao titulo="Condição" var="condicao" opcoes="Recebido integralmente;Recebido parcialmente;Recebido com ressalvas"/][/@grupo][@memo titulo="Ressalvas" var="ressalvas" colunas="90" linhas="3"/]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="ATESTADO DE RECEBIMENTO" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>Recebimento:</strong> ${dataRecebimento!} - ${condicao!}</p>[#if (ressalvas!"") != ""]<p><strong>Ressalvas:</strong><br/>${ressalvas!}</p>[/#if]
[#if qtdItens??]
