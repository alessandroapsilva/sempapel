...
[@grupo titulo="Processo de compra"]
    ...
    [@grupo][@data titulo="Validade" var="validade"/][@texto titulo="Condição de pagamento" var="condicaoPagamento" largura="45" maxcaracteres="100"/][/@grupo]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="COTAÇÃO DE PREÇOS" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>Validade:</strong> ${validade!} &nbsp; <strong>Pagamento:</strong> ${condicaoPagamento!}</p>
[#if qtdItens??]
