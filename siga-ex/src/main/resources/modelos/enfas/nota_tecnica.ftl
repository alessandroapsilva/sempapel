...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="NOTA TÉCNICA" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        [#if (unidadeDemandante!"") != ""]<p><strong>Unidade demandante:</strong> ${unidadeDemandante!}</p>[/#if]<p><strong>Conclusão:</strong><br/>${conclusao!}</p>
