...
[@grupo titulo="Identificação"]
    ...
    [/@grupo]
[/@grupo]
[@grupo titulo="Encaminhamento interno"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="MEMORANDO" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        <p><strong>DE:</strong> ${doc.titular.lotacao.descricao!}</p><p><strong>PARA:</strong> ${unidadeDestinataria!}</p>[#if (aosCuidados!"") != ""]<p><strong>A/C:</strong> ${aosCuidados!}</p>[/#if]<p><strong>Prioridade:</strong> ${prioridade!"Normal"}</p>
