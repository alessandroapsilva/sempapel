...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="CARTA" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
    <div style="font-family: Arial; font-size: ${tl}; line-height: 1.5;">
        ...
        <p><strong>Destinatário:</strong> ${(tratamento!"")} ${(nomeDestinatario!"")}</p>[#if (endereco!"") != ""]<p>${endereco!}</p>[/#if]
