[#--
 Modelo: Mapa Comparativo de Preços
...
[@grupo titulo="Processo de compra"]
    ...
    [@memo titulo="Fornecedores consultados" var="fornecedoresConsultados" colunas="90" linhas="4" obrigatorio=true/][@memo titulo="Critério e conclusão" var="criterioConclusao" colunas="90" linhas="4" obrigatorio=true/]
[/@grupo]
[@grupo titulo="Itens"]
...
[#else]
    [#assign tl="11pt"/]
[/#if]
[@estiloBrasaoCentralizado tipo="MAPA COMPARATIVO DE PREÇOS" tamanhoLetra=tl formatarOrgao=true numeracaoCentralizada=false dataAntesDaAssinatura=true]
...
<p><strong>Fornecedores consultados:</strong><br/>${fornecedoresConsultados!}</p><p><strong>Critério e conclusão:</strong><br/>${criterioConclusao!}</p>
[#if qtdItens??]
